...
import com.example.salesmis.service.impl.IngredientServiceImpl;
...
import com.example.salesmis.view.IngredientManagementPanel;
            ...
            try {
                ...
                LoginFrame loginFrame = new LoginFrame(accountService, (loggedInAccount) -> {
                    MainFrame frame = new MainFrame(
                        ...
                        new IngredientManagementPanel(ingredientController),
